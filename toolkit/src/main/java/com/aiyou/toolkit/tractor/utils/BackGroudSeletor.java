package com.aiyou.toolkit.tractor.utils;
...
public class BackGroudSeletor {
     ...
     * @return
     */
    public static StateListDrawable getCheckedSelector(Drawable normalDraw, Drawable pressedDraw) {
    ...
    public static ColorStateList getColorStateList(int checked, int normal) {
