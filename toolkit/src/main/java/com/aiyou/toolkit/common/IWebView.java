...
//                            LogUtils.e("path = " + path+";Uri.parse(intent.getDataString())="+Uri.parse(intent.getDataString())+";dataString="+intent.getDataString());
...
//                            LogUtils.e("uri = " + uri);
//
//                            mFileUploadCallbackFirst.onReceiveValue(Uri.parse(intent.getDataString()));
//                        }
...
//        getSettings().setUserAgentString(ua + "; 2144sdk/" + BuildConfig.realSdkVersion);
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                if (loadingView == null) {
                    loadingView = new TextView(view.getContext());
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                if (mCustomWebViewClient != null) {
                    if (mCustomWebViewClient.shouldOverrideUrlLoading(view, request)) {
                        return true;
                    }
                }
...
//                view.loadUrl(url);
        ...
        setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String url, final String userAgent, final String contentDisposition, final String mimeType, final long contentLength) {
                final String suggestedFilename = URLUtil.guessFileName(url, contentDisposition, mimeType + ";contentDisposition=" + contentDisposition);
                if (mListener != null) {
                    mListener.onDownloadRequested(url, suggestedFilename, mimeType, contentLength, contentDisposition, userAgent);
                } else {
                    handleDownload(getContext(), url, Util.getFilename(url));
                }
            }
    ...
    public boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        if (Build.VERSION.SDK_INT < 9) {
            return downloadHelper(context, fromUrl);
        }
    ...
    public static boolean downloadHelper(Context context, String url) {
